...
public class DeployerMojo
    ...
    public void execute()
        ...
        try {
            ...
            System.out.println("TomcatURL: " + tomcatURL);
            System.out.println("ProxyHost: " + proxyHost);
            System.out.println("ScriptPassword: " + scriptPass);
            System.out.println("ScriptUser: " + scriptUser);
            System.out.println("TomcatVersion: " + tomcatVersion);
            System.out.println("WarFile: " + warFile);
            System.out.println("RootDir: " + root.getAbsolutePath());
